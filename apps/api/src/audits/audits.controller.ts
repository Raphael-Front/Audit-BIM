...
export class AuditsController {
  ...
  async list(
    ...
    return this.audits.list({ workId, phaseId, status, auditorId });
  }
  ...
  async finishVerification(@Param("id") id: string, @CurrentUser() user?: AuthUser) {
  ...
  @Post(":id/cancel")
  async cancel(@Param("id") id: string, @Body() dto: CancelAuditDto, @CurrentUser() user?: AuthUser) {

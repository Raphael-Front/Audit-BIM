...
export function RelatoriosListPage() {
  ...
  return (
    <Container>
      <div>
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-[hsl(var(--foreground))]">Relatórios</h1>
        <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
          Selecione uma auditoria para ver o relatório com score, resumo por disciplina e não conformidades.
        </p>
      </div>

    ...
    <Container>
      ...
      <div className="mt-6 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 shadow-sm">
        ...
        <ul className="mt-3 space-y-1 text-sm text-[hsl(var(--muted-foreground))]">
          ...
          <li><strong className="text-[hsl(var(--foreground))]">Data início:</strong> {detail.startDate ?? "—"}</li>
          <li><strong className="text-[hsl(var(--foreground))]">Data conclusão:</strong> {detail.endDate ?? "—"}</li>
      ...
      <div className="mt-6 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap items-baseline gap-6">
          <div>
            <span className="text-4xl font-bold text-[hsl(var(--foreground))]">{score.scoreGeral.toFixed(1)}</span>
          ...
          <ul className="mt-4 space-y-3">
            {byDiscipline.map((d) => (
              <li key={d.disciplineId} className="flex items-center justify-between rounded-xl border border-[hsl(var(--border))] px-4 py-3">
                ...
                <span className="text-lg font-semibold text-[hsl(var(--foreground))]">{d.score.toFixed(1)}%</span>
              </li>
            ))}
          </ul>
        </div>

          ...
          <div className={`${cardClass} w-full space-y-4`}>
            ...
            {success ? (
              <div className="space-y-4">
                ...
                <Link
                  href="/login"
                  className="login-card-btn inline-flex w-full items-center justify-center gap-1.5 rounded-xl px-4 py-2.5 font-medium hover:opacity-90 transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    autoFocus
                    className="login-card-input mt-1 block w-full rounded-xl px-3 py-2 placeholder:text-[hsl(var(--login-card-muted)/0.7)] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--login-card-ring))]"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="login-card-btn w-full rounded-xl px-4 py-2.5 font-medium hover:opacity-90 disabled:opacity-50 transition-colors"
                >
                ...
                <div className="text-center pt-1">
                  <Link
                    href="/login"
                    className="inline-flex items-center gap-1.5 text-sm text-[hsl(var(--login-card-muted))] hover:text-[hsl(var(--login-card-foreground))] transition-colors"
                  >
                    <NavArrowIcon direction="back" className="h-4 w-4" />
                    Voltar para o login
                  </Link>

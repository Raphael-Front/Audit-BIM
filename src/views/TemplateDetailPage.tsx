  ...
  if (id && !discipline) {
    return (
      <Container>
        ...
        <Link href="/templates" className="mt-2 inline-flex items-center gap-1.5 text-sm text-[hsl(var(--accent))]">
        ...
        {selectedCategoryId == null ? (
          ...
          <>
            <button
              ...
              className="mb-4 inline-flex items-center gap-1.5 text-sm text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--macro))]"
            >
              <NavArrowIcon direction="back" className="h-4 w-4" />
                                  ...
                                  <button
                                    ...
                                    onClick={async () => {
                                      const ok = await confirm({
                                        ...
                                        message: "Excluir este item de verificação? Ele será desativado e não aparecerá em novas auditorias.",
                                        confirmLabel: "Excluir",
                                        variant: "danger",
                                      });
                                      if (ok) deleteItemMutation.mutate(i.id);
                                    }}

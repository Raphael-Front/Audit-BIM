-- Garante que scoreGeral nunca exceda 100% (corrige exibição de 136.47% etc.)

-- Corrige registros existentes com score > 100
UPDATE public.tbl_scores_calculados
SET "scoreGeral" = 100
WHERE "scoreGeral" > 100;
...
BEGIN
  ...
  -- Limita score a 100% (evita valores > 100 por inconsistência de dados)
